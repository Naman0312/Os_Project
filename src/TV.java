...
public class TV extends JFrame{
	...
	JButton Folder = new JButton("Folder",new ImageIcon(getClass().getResource("/icons/Folder.png")));
	JButton Folder2 = new JButton("Folder2",new ImageIcon(getClass().getResource("/icons/Folder.png")));
	JButton Settings = new JButton("Settings",new ImageIcon(getClass().getResource("/icons/Folder.png")));
	public TV(){
		log = new JTextArea();
		...
		//Folder.setIcon(new ImageIcon(getClass().getResource("/icons/Folder.png")));
		...
		Viewer.setBounds(25, 25, 250, 250);
		Folder.setBounds(325, 25, 250, 250);
		Folder2.setBounds(625, 25, 250, 250);
		Settings.setBounds(925, 25, 250, 250);
		...
		Folder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(VIEWER_IS_OPEN){
					Card.show(container, "Folder");
				}else{
					JPanel Fold =Folder();
					container.add(Fold);
					container.getLayout().addLayoutComponent("Folder", Fold);
					JButton FoldButton=new JButton("Folder");
					FoldButton.setPreferredSize(new Dimension(100, 40));
		...
		Settings.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(VIEWER_IS_OPEN){
					...
					JPanel Sett =Settings();
					container.add(Sett);
					container.getLayout().addLayoutComponent("Settings", Sett);
					JButton SettButton=new JButton("Settings");
					SettButton.setPreferredSize(new Dimension(100, 40));
		...
		Folder2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(VIEWER_IS_OPEN){
					Card.show(container, "Folder2");
				}else{
					JPanel Fold2 =Folder2();
					container.add(Fold2);
					container.getLayout().addLayoutComponent("Folder2", Fold2);
					JButton Fold2Button=new JButton("Folder2");
					Fold2Button.setPreferredSize(new Dimension(100, 40));
					Fold2Button.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							Card.next(container);
						}
					});
...
//													container.add(x1);
	...
	public JPanel Folder(){
		...
		Folder.setPreferredSize(new Dimension(150,150));
		Back.setEnabled(true);
		Back.setIcon(new ImageIcon(TV.class.getResource("/icons/Back.png")));
		...
		Controller.add(Back);
		container.add(backGround);
		Folder.add(container,BorderLayout.CENTER);
		Folder.add(Controller,BorderLayout.NORTH);
		return Folder;}
	
	
	public static JPanel Folder2(){
		...
		controllerLayout.setAlignment(FlowLayout.LEFT);
		container.setLayout(containarLayout);
		Folder2.setLayout(new BorderLayout());
		Controller.setLayout(controllerLayout);
		
		Controller.setPreferredSize(new Dimension(MAXIMIZED_HORIZ, 100));
		container.setBorder(BorderFactory.createLineBorder(null, 5, true));
		
		Folder2.setPreferredSize(new Dimension(150,150));
		Back.setEnabled(false);
		Back.setIcon(new ImageIcon(TV.class.getResource("/icons/Back.png")));
		...
		Controller.add(Back);
		container.add(backGround);
		Folder2.add(container,BorderLayout.CENTER);
		Folder2.add(Controller,BorderLayout.NORTH);
		return Folder2;}
	...
	public static JPanel Settings(){
		...
		Settings.add(Controller,BorderLayout.NORTH);
		return Settings;}
